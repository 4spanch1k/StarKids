enum RequestType {
  birthdayRequest(
    ...
    label: 'День рождения',
    selectorDescription:
        'Праздник с выбором филиала, гостей и пожеланий — пакет и дату можно выбрать позже.',
    screenTitle: 'Заявка',
    formTitle: 'Соберём праздник за пару минут',
    formDescription:
        'Укажите филиал и контакты. Пакет и дата могут определиться позже.',
    submitButtonLabel: 'Отправить заявку',
    successTitle: 'Заявка принята',
    successDescription:
        'Мы уже передали запрос менеджеру Boom Bala. Менеджер свяжется с вами, чтобы подтвердить детали праздника.',
