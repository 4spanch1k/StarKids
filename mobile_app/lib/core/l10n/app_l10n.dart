...
class AppL10n {
  ...
  String get profileLoadError => _kk
      ? 'Профиль жүктелмеді'
  ...
  String get pushNotifications => _kk ? 'Push-хабарламалар' : 'Push-уведомления';
  ...
  String get noChildren =>
      _kk ? 'Балалар жоқ.' : 'Дети не добавлены.';
  ...
  String get childNameRequired =>
      _kk ? 'Аты міндетті.' : 'Имя обязательно.';
  String get childBirthDateRequired =>
      _kk ? 'Туған күні міндетті.' : 'Дата рождения обязательна.';
  String get childGenderRequired =>
      _kk ? 'Жынысын таңдаңыз.' : 'Выберите пол.';
  String get childNameTooLong =>
      _kk ? 'Аты тым ұзын.' : 'Имя слишком длинное.';
  ...
  String get childTooOld =>
      _kk ? 'Ребёнку не может быть больше 18 лет.' : 'Ребёнку не может быть больше 18 лет.';

  // ─── Birthday reminder ────────────────────────────────────────────────────

  String birthdayReminderTitle(String name) =>
      _kk ? '$name — бүгін туған күн! 🎂' : 'Сегодня день рождения — $name! 🎂';
  String get birthdayFreeEntry =>
      _kk ? 'Именинникке туған күнінде — тегін' : 'Имениннику в день рождения — бесплатно';
  String get birthdayPackageHint =>
      _kk
          ? 'Туған күнді мерекелеу үшін пакет таңдауға болады'
          : 'Можно выбрать пакет для празднования дня рождения';
  String get chooseBirthdayPackage =>
      _kk ? 'Пакет таңдау' : 'Выбрать пакет';
