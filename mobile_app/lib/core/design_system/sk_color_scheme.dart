...
abstract final class SKColors {
  ...
  static const coral500 = Color(0xFFFF5F61); // primary brand / CTA
  static const coral600 = Color(0xFFE45154);
...
class SKColorScheme {
  ...
  factory SKColorScheme.light() => const SKColorScheme._(
        ...
        accent: SKColors.coral500,
        accentSoft: SKColors.coral100,
        cta: SKColors.coral500,
        ctaPressed: SKColors.coral700,
        ctaSoft: SKColors.coral100,
  ...
  factory SKColorScheme.dark() => const SKColorScheme._(
        ...
        cta: Color(0xFFFF7678),
        ctaPressed: SKColors.coral700,
        ctaSoft: Color(0x2EFF5F61),
        success: SKColors.mint500,
